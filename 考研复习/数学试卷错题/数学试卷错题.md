...
12. $[1,+\infty) \Cup (-\infty,-1]$
13. $27$
14. $3$ 或 $\dfrac{3}{2}$

15 
$$
\left ( \begin{matrix}0 & k \\
k & 0
 \end{matrix}\right )
$$
...
$$
I_{1}=\int^{1}_{0}(\cos x)^2,I_{2}=\int^{1}_{0}\cos x^2,I_{3}=\int^{1}_{0}(\sin x)^2,I_{4}=\int^{1}_{0}\sin x^2
$$
$$
(\sin x)^2-\sin x^2 \sim \left( x-\dfrac{x^3}{6} \right)^2-\left( x^2-\dfrac{x^6}{6} \right) = -\dfrac{x^4}{3}+\dfrac{x^6}{36} +\dfrac{x^6}{6} < 0  
$$