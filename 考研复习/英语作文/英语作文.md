...
$$
\large A=\left ( \begin{matrix}0 & 2 & -2 \\
2 & 4 & 4 \\
-2 & 4 & -3
 \end{matrix}\right ) \implies tr A=1,|A|=-36,trA^*=-36
$$
$$
\large \lambda^3 -\lambda^2 -36\lambda + 36 = 0 \implies \lambda = 1,6,-6
$$
$$
\large \lambda^3 - trA \lambda^2 + trA^* \lambda-|A|=0
$$
