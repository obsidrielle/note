...
$$
(1+x)^{\dfrac{1}{x}}= A + Bx + Cx^2 + o(x^2)
$$
$$
\begin{align}
e^{\dfrac{1}{x}\ln(1+x)} &= e^{\dfrac{1}{x}\left[ x-\dfrac{1}{2}x^2+\dfrac{1}{3}x^3 \right] } = e^{1-\dfrac{1}{2}x+\dfrac{1}{3}x^2}  \\
&= e\times e^{-\dfrac{1}{2}x+\dfrac{1}{3}x^2} \\
&= e \times \left[  1- \dfrac{1}{2}x+\dfrac{1}{3}x^2 +\dfrac{1}{2} \left[  -\dfrac{1}{2}x+\dfrac{1}{3}x^2 \right]^2  \right]  \\
&= e \left[ 1-\dfrac{1}{2}x +\dfrac{11}{24}x^2 + o(x^2) \right] \implies A = e,B=-\dfrac{1}{2}e,C=\dfrac{11}{24} e
\end{align}
$$
