...
$$
\begin{align}
\lim_{ n \to \infty } \lim_{ x \to \infty } \dfrac{\sqrt[n]{ \prod^{n}_{i=1}(x+i) }-x}{n} &= \lim_{ n \to \infty } \lim_{ x \to \infty } x \dfrac{\left[ \sqrt[n]{ \prod^{n}_{i=1} \left( 1+\dfrac{i}{x} \right)     }-1 \right]   }{n}  \\
&= \lim_{ n \to \infty } \lim_{ x \to 0 } \dfrac{\sqrt[n]{ \prod^{n}_{i=1}(1+ix)  }-1}{xn}  \\
&= \lim_{ n \to \infty } \lim_{ x \to 0 } \dfrac{\dfrac{1}{n}\left[\prod^{n}_{i=1}(1+ix)-1 \right] }{nx} \\
&= \lim_{ n \to \infty } \dfrac{\dfrac{n(n+1)}{2}}{n^2} = \dfrac{1}{2}     
\end{align}
$$
11. $\ln 2$
12. $\dfrac{1}{3}$
...
$$
y=\sqrt{ 3}x \implies \sqrt{ 3 } r\sin \theta = \sqrt{ 3 }r \cos \theta \implies \theta = \dfrac{\pi }{4}
$$
