...
`The notice is to inform that Prof. Smith needs a student serving as a volunteer for his research project on campus sports activities. `

`The project aims to investigate the situation of students doing sports and explore effective ways to improve health and strength bodies of students. The volunteers will be requested to collect the data of sports activities. Preference will be given whom have experience and free meal will be offered.`

`Those interested in it may send an application to prof-smith@edu.cn before December 15th, for application and interview prior to volunteering in the project`.