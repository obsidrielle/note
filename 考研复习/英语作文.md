...
设 $\alpha_{1},\alpha_{2},\dots,\alpha_{n}$ 是线性无关的, 分别属于 $A$ 的特征值 $\lambda_{1},\lambda_{2},\dots,\lambda_{n}$ 的特征向量
$$
\begin{align}
P&=\left ( \begin{matrix}\alpha_{1},\alpha_{2},\dots,\alpha_{n}
 \end{matrix}\right ) \implies AP=P \Uplambda  \\
& \implies A(\alpha_{1},\alpha_{2},\dots,\alpha_{n})=(A\alpha_{1},A\alpha_{2},\dots ,A\alpha_{n}) = (\lambda_{1}\alpha_{1},\lambda_{2}\alpha_{2},\dots,\lambda_{n}\alpha_{n}) \\
&= (\alpha_{1},\alpha_{2},\dots,\alpha_{n}) \left ( \begin{matrix}\lambda_{1}  & & & \\
& \lambda_{2} & & \\
& & \ddots & & \\
& & & \lambda_{n} 
 \end{matrix}\right ) = P \Uplambda
\end{align}
$$
