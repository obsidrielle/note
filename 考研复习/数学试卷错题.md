...
$$
\sqrt{ 3x^2-2x-1 }=\sqrt{ 3\left( x-\dfrac{1}{3} \right)^2-\dfrac{4}{3}  }
$$
设
$$
I=\int^{2}_{1} \dfrac{dx}{\left( t+\dfrac{1}{3} \right)\sqrt{ 3t^2-\dfrac{4}{3} } }
$$
设 $t=\dfrac{2}{3}\sec \theta \implies 3t^2 = \dfrac{4}{3}\sec^2\theta$
$$
I = \int^{}_{1}
$$
$$
\dfrac{1}{\dfrac{1}{\cos x} + 1 + \dfrac{\sin x}{\cos x}} = \dfrac{\cos x}{\sin x + \cos x}
$$
